...
public class Parser {
    ...
    private Block block(){
        ...
        while(!have(Token.RCURLY )&& start){
            ...
            if(have(Token.IF)){
                ...
                //    reportParserError(" MissingConditionError : If statement", line);
                //}
                ...
                mustbe(Token.LPARAN);
                //if(!have(Token.LPARAN)){
                //    reportParserError(" MissingConditionError : While statement", line);
                //}
                ...
                mustbe(Token.LPARAN);
                //if(!have(Token.LPARAN)){
                //    reportParserError(" MissingConditionError : For statement", line);
                //}
    ...
    private Symbol literal() {
        ...
        return new Symbol(Token.NULL,line);
