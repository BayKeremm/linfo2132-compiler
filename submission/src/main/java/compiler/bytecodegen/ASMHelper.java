...
import compiler.Parser.ArrayInitializer;
import compiler.Parser.Expression;
import compiler.Parser.FunctionCallExpression;
import compiler.Parser.StructDeclaration;
import compiler.Parser.VariableGod;
...
public class ASMHelper {
    ...
    public void writeClass(){
        ...
        try(var outFile = new FileOutputStream(outputName+".class")) {
            outFile.write(bytes);
        }
        catch(IOException e) {
            e.printStackTrace();
    ...
    public void startNewScope(){
        ...
        if(currentScope != null){
            ...
            var prev = currentScope.prevScope;
            while(prev != null){
                index = index + 1;
                prev = prev.prevScope;
            }
    ...
    public void popScope(){
        ...
        //}
        int i = currentScope.getCurrIndex();
        currentScope = currentScope.getPrevScope();
        if(currentScope!= null){
            currentScope.setStartIndex(i);
        }
    }
