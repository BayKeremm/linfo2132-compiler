...
public class ByteCodeWizard implements ByteVisitor{
    ...
    void writeOverwrites(Expression param){
        String t = param.getType().type();
        switch (t){
            case "string":
    ...
    void writeln(Expression param){
        asmHelper.setPrintStream();
        param.codeGen(this);
        String t = param.getType().type();
        switch (t){
            case "string":
                asmHelper.printlnStr();
                break;
            case "bool", "int":
                asmHelper.printInt();
                break;
